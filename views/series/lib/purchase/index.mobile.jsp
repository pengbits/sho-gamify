	...
	@file			series/views/purchase/index.mobile.jsp
	@type			page
	@author			dmccleod
	@author			nwebb
	@modified		05/13/14	
	...
	<tiles:insertDefinition name="series.purchase.faux_carousel.mobile">
		<tiles:putAttribute name="image"		value="/assets/images/series/queer/promos/purchase_640x400.jpg" />
		<tiles:putAttribute name="headline"	 	value="Order Your Digital Copy of Queer as Folk Now" />
